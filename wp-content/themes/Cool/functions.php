<?php
    ...
    $theme = new Themater('Cool');
    $theme->options['includes'] = array('featuredposts', 'social_profiles', 'aboutus');
    
    $theme->options['plugins_options']['featuredposts'] = array('image_sizes' => '615px. x 300px.', 'speed' => '400', 'effect' => 'fade');
    $theme->options['plugins_options']['aboutus'] = array('hook' => 'content_before');
    ...
    // Register the Homepage widgets
    register_sidebar(array(
        'name' => 'Homepage Widget Area 1',
        'id' => 'homepage_1',
        'description' => 'The homepage #1 widget area',
        'before_widget' => '<ul class="widget-container"><li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li></ul>',
        'before_title' => '<h3 class="widgettitle">',
        'after_title' => '</h3>'
    ...
    register_sidebar(array(
        ...
        'id' => 'homepage_2',
        'description' => 'The homepage #2 widget area',
        'before_widget' => '<ul class="widget-container"><li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li></ul>',
        'before_title' => '<h3 class="widgettitle">',
        'after_title' => '</h3>'
    ...
    $theme->add_hook('homepage_1', 'homepage_1_default_widgets');
    $theme->add_hook('homepage_2', 'homepage_2_default_widgets');
    
    function homepage_1_default_widgets ()
    {
        global $theme;
        $theme->display_widget('InfoBox', 
            array( 
                'title' => 'Fully Responsive', 
                'description' => 'Lorem ipsum dolor sit amet, test link adipiscing elit. Nullam dignissim convallis est lone part',
                'link' => '#',
                'more_label' => '',
                'image' => get_template_directory_uri() . '/images/services1.png',
                'image_position' => 'before_description',
        ...
        $theme->display_widget('InfoBox', 
            array( 
                'title' => 'Infobox with image', 
                'description' => 'Lorem ipsum dolor sit amet, test link adipiscing elit. Nullam dignissim convallis est lone part',
                'link' => '#',
                'more_label' => '',
                'image' => get_template_directory_uri() . '/images/imageservices1.jpg',
    ...
    function homepage_2_default_widgets ()
    {
        global $theme;
        $theme->display_widget('InfoBox', 
            array( 
                ...
                'link' => '#',
                'more_label' => '',
                'image' => get_template_directory_uri() . '/images/services2.png',
                'image_position' => 'before_description',
                'image_align' => 'aligncenter',
                'link_title' => 'true',
                'link_description' => '',
        ...
        $theme->display_widget('InfoBox', 
            array( 
                ...
                'link' => '#',
                'more_label' => '',
                'image' => get_template_directory_uri() . '/images/imageservices2.jpg',
                'image_position' => 'before_title',
                'image_align' => 'aligncenter',
                'link_title' => 'true',
                'link_description' => '',
        ...
        function footer_1_default_widgets ()
        {
            ...
            $theme->display_widget('Posts',  
                array(
                    ...
                    'excerpt_length' => '26',
                    'featured_image_width' => '60',
                    'featured_image_height' => '40',
